 ...
 */
function professional_responsive_theme_html_head_alter(&$head_elements) {
 ...
 */
function professional_responsive_theme_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function professional_responsive_theme_preprocess_node(&$variables) {
  $node = $variables['node'];
...
function professional_responsive_theme_page_alter($page) {
